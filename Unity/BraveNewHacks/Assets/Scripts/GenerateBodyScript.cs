...
public class GenerateBodyScript : MonoBehaviour {
	...
	void Start () {
		...
		int[] randomInts = { 1, 6, 12, 4, 3, 5, 8, 10, 11, 9, 18, 19, 15, 14, 20, 10, 11, 4, 2, 5 };
		...
		for (int a = 0; a < array.Length - 1; a = a + 1) {
			...
			deadGuyScript dgScript = cube.GetComponent<deadGuyScript> ();
			dgScript.textBox = textBox;
			dgScript.displayText = array [a];
